...
$tgl_pengeluaran = cek_input($_POST['tgl_pengeluaran']);
...
if (!empty($tgl_pemasukan) || !empty($jumlah) || is_numeric($jumlah) || !empty($keterangan)) {
    ...
    if ($query_perihal) {
        ...
        $query_cashinout =  "INSERT INTO `cashinout` (`tanggal`,`jenis`,`jumlah`, `id_perihal`) VALUES ('$tgl_pengeluaran','$nama_perihal','$jumlah', '$perihal_id')";
